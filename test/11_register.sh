...
OUTPUT=`curl -s -c cookiejar -i -H "Content-Type: application/json" -X POST -d '{"email":"y@xyz.com","fname":"Yirstname","lname":"Yastname","pass":"yyzXYZ"}' http://localhost:8080/register`
echo $OUTPUT
